...
public class ItemDragActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            intdaily = (List<ItnDaily>) extras.getSerializable("intDaily");
        } catch (Exception e) {
    ...
    public void initMenu() {
        ...
        mMenu.addItem(new MenuItem.Builder().setWidth((int) getResources().getDimension(R.dimen.slv_item_bg_btn_width_img))
                .setBackground(Util.getDrawable(this, R.drawable.btn_right1))
                .setDirection(MenuItem.DIRECTION_RIGHT)
    ...
    private BaseAdapter mAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            cvh.imgLogo2.setImageDrawable(Util.getDrawable(ItemDragActivity.this, R.drawable.ic_google));
